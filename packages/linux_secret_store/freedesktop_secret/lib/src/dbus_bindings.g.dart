...
class OrgFreedesktopSecretsCollectionCreated extends DBusSignal {
  ...
  OrgFreedesktopSecretsCollectionCreated(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class OrgFreedesktopSecretsCollectionDeleted extends DBusSignal {
  ...
  OrgFreedesktopSecretsCollectionDeleted(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class OrgFreedesktopSecretsCollectionChanged extends DBusSignal {
  ...
  OrgFreedesktopSecretsCollectionChanged(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class OrgFreedesktopSecretsItemCreated extends DBusSignal {
  ...
  OrgFreedesktopSecretsItemCreated(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class OrgFreedesktopSecretsItemDeleted extends DBusSignal {
  ...
  OrgFreedesktopSecretsItemDeleted(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class OrgFreedesktopSecretsItemChanged extends DBusSignal {
  ...
  OrgFreedesktopSecretsItemChanged(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class OrgFreedesktopSecretsCompleted extends DBusSignal {
  ...
  OrgFreedesktopSecretsCompleted(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class OrgFreedesktopSecrets extends DBusRemoteObject {
  ...
  OrgFreedesktopSecrets(DBusClient client, String destination, {DBusObjectPath path = const DBusObjectPath.unchecked('/org/freedesktop/secrets')}) : super(client, name: destination, path: path) {
    collectionCreated = DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.Secret.Service', name: 'CollectionCreated', signature: DBusSignature('o')).asBroadcastStream().map((signal) => OrgFreedesktopSecretsCollectionCreated(signal));

    collectionDeleted = DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.Secret.Service', name: 'CollectionDeleted', signature: DBusSignature('o')).asBroadcastStream().map((signal) => OrgFreedesktopSecretsCollectionDeleted(signal));

    collectionChanged = DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.Secret.Service', name: 'CollectionChanged', signature: DBusSignature('o')).asBroadcastStream().map((signal) => OrgFreedesktopSecretsCollectionChanged(signal));

    itemCreated = DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.Secret.Collection', name: 'ItemCreated', signature: DBusSignature('o')).asBroadcastStream().map((signal) => OrgFreedesktopSecretsItemCreated(signal));

    itemDeleted = DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.Secret.Collection', name: 'ItemDeleted', signature: DBusSignature('o')).asBroadcastStream().map((signal) => OrgFreedesktopSecretsItemDeleted(signal));

    itemChanged = DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.Secret.Collection', name: 'ItemChanged', signature: DBusSignature('o')).asBroadcastStream().map((signal) => OrgFreedesktopSecretsItemChanged(signal));

    completed = DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.Secret.Prompt', name: 'Completed', signature: DBusSignature('bv')).asBroadcastStream().map((signal) => OrgFreedesktopSecretsCompleted(signal));
  }
  ...
  Future<List<DBusObjectPath>> callSearchItems_(Map<String, String> attributes, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
  ...
  Future<DBusObjectPath> callDelete_({bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
